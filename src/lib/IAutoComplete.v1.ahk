...
#Include C:\Users\bacona\AppData\Local\Programs\AutoHotkey\v2\Lib\RegisterSyncCallback.ahk
; ==================================================================================================================================
...
IAutoComplete_SubclassProc(HWND, Msg, wParam, lParam, ID, Data) {
	WM_DESTROY:=0x0002, WM_GETDLGCODE:=0x0087, VK_RETURN:=13, DLGC_WANTALLKEYS:=0x0004
...
IEnumString_Clone(IES, ObjPtr) { ; Not sure about the reference counter (IES + (A_PtrSize * 8))!
	...
	; Set the reference counter to zero or one in this case???
	NumPut(0, IESClone + (A_PtrSize * 8), "UPtr") 
