...
class WinClip extends WinClip_base {
	...
	skipFormats := {
		2 	: 0, ;"CF_BITMAP"
		17 	: 0, ;"CF_DIBV5"
		130	: 0, ;"CF_DSPBITMAP" 0x0082
		142 : 0, ;"CF_DSPENHMETAFILE" 0x008E
		131 : 0, ;"CF_DSPMETAFILEPICT" 0x0083
		129 : 0, ;"CF_DSPTEXT" 0x0081
		128 : 0, ;"CF_OWNERDISPLAY" 0x0080
		3 	: 0, ;"CF_METAFILEPICT"
		7 	: 0, ;"CF_OEMTEXT"
		1 	: 0, ;"CF_TEXT"
	}
	...
	static _GetRTF(text?) {
		...
		return strget( text, StrLen(text), "UTF-8" )
	}
